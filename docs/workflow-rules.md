# Workflow rules — SreerajP_Devi

Read this file before starting or finishing any change to the project. These rules are
part of the project rules in [../.agents/AGENTS.md](../.agents/AGENTS.md) and apply to every change.
...
- Proceed **only** on an explicit "approved". Silence, a question, or an
